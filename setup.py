...
class build_ext(_build_ext):
    def finalize_options(self):
        ...
        sources = [ 'src/modify_orbits_forces.c', 'src/integrator_euler.c', 'src/gas_dynamical_friction.c', 'src/gravitational_harmonics.c', 'src/integrator_implicit_midpoint.c', 'src/turbulent_force.c', 'src/exponential_migration.c', 'src/disk_profile.c', 'src/gr_full.c', 'src/gr.c', 'src/interpolation.c', 'src/tides_spin.c', 'src/central_force.c', 'src/radiation_forces.c', 'src/gas_damping_timescale.c', 'src/integrator_rk4.c', 'src/linkedlist.c', 'src/steppers.c', 'src/stochastic_forces.c', 'src/modify_mass.c', 'src/lense_thirring.c', 'src/tides_constant_time_lag.c', 'src/integrator_rk2.c', 'src/type_I_migration.c', 'src/yarkovsky_effect.c', 'src/rebxtools.c', 'src/input.c', 'src/inner_disk_edge.c', 'src/track_min_distance.c', 'src/modify_orbits_direct.c', 'src/output.c', 'src/core.c', 'src/gr_potential.c', 'src/integrate_force.c'],
